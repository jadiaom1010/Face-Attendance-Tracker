...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "faceattendancerealtime-8c84f.appspot.com"
})
        ...
        if counter != 0:
            ...
            if counter == 1:
                ...
                if secondsElapsed > 30:
                    ...
                    ref.child('last_attendance_time').set(str(datetime.now().strftime("%Y-%m-%d %H:%M:%S")))
                else:
                    modeType = 3
                    counter = 0
                    imgBackground[44:44 + 633, 808:808 + 414] = imgModeList[modeType]
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    cv2.putText(imgBackground, str(id), (1006, 493),
                                cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(studentInfo['name']), (910, 625),
